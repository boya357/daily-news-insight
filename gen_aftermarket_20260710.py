...
# ============================================================
# 4.5 持仓股深度诊断（独立Section，内容更丰富）
# ============================================================
holdings_diagnosis_html = """
<div style="display: flex; flex-direction: column; gap: 18px;">
    
    <!-- 英维克 -->
    <div style="background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 14px; padding: 18px; backdrop-filter: blur(10px);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.08);">
            <div>
                <span style="font-size: 17px; font-weight: 700; color: var(--text-primary);">英维克</span>
                <span style="font-size: 12px; color: var(--text-muted); margin-left: 8px;">002837 · 液冷散热龙头</span>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 20px; font-weight: 700; color: #f87171;">73.54</div>
                <div style="font-size: 13px; color: #f87171; font-weight: 600;">-3.07%</div>
            </div>
        </div>
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 14px;">
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">成交额</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">54.95亿</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">换手率</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">6.37%</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">最高/最低</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">78.50 / 73.38</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">振幅</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">6.75%</div>
            </div>
        </div>
        <div style="line-height: 1.85; font-size: 13.5px; color: var(--text-secondary);">
            <p style="margin: 0 0 10px 0;"><strong style="color: #f87171;">📉 当日表现：高开低走放量长阴，跌破多条均线</strong><br>
            英维克今日高开后冲高至78.50元（+3.5%），但午后跟随AI硬件板块集体跳水，最低探至73.38元，最终收于73.54元，跌幅3.07%。全天成交54.95亿，换手率6.37%，成交量较前几日明显放大，属于放量下跌形态。盘中几乎没有像样的反弹，尾盘收在最低点附近，多头抵抗微弱。</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #fbbf24;">📊 技术面判断：短期进入调整通道</strong><br>
            • <strong>均线系统</strong>：MA5(73.38元)已被跌破，MA10(74.07元)和MA20(75.53元)全部失守，短期均线呈现空头排列，5日均线拐头向下形成压制<br>
            • <strong>支撑位</strong>：第一支撑73元（今日低点附近），若有效跌破则下看68-70元区间（前期平台+跌停价68.28元），这是中期重要支撑带<br>
            • <strong>压力位</strong>：第一压力75-76元（MA10+MA20区域），第二压力78.5元（今日高点+前期平台）<br>
            • <strong>MACD</strong>：DIF -2.54，DEA -2.93，红柱持续缩小，多头动能明显减弱，有死叉迹象<br>
            • <strong>RSI</strong>：45.66，处于正常区间但偏弱势，尚未进入超卖，意味着调整可能尚未结束<br>
            • <strong>量价关系</strong>：放量下跌说明抛压较重，不是地量地价的见底信号</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #60a5fa;">💰 资金面与基本面</strong><br>
            液冷板块今日整体回调，属于AI硬件产业链系统性调整的一部分。但从中长期看，液冷行业的产业逻辑依然坚实——英伟达Rubin系列全面转向全液冷方案，英特尔与英维克联合发布液冷工质认证标准，AI算力需求爆发带动液冷渗透率快速提升。公司一季度营收增长119.61%，净利润增长925.71%，业绩高增长态势明确。近32位分析师给出买入/增持评级，目标价均值113元，当前价格距目标价仍有较大空间。</p>
            
            <p style="margin: 0;"><strong style="color: #c084fc;">🎯 操作建议：反弹减仓，等待企稳</strong><br>
            • 若周一反弹至<strong style="color: #4ade80;">76元以上</strong>，建议减仓1/3，降低持仓风险敞口<br>
            • 若跌破<strong style="color: #f87171;">70元整数关口</strong>，应果断止损离场，不可恋战，下方68元支撑能否守住存疑<br>
            • 中期等明确止跌信号：缩量至30亿以下+连续3日站稳MA10，再考虑回补仓位<br>
            • 当前从高点93.52元已回撤约21%，但调整时间尚不充分，建议耐心等待<br>
            • 仓位建议：从现有仓位降至1/3，保留底仓观察液冷行业催化节奏</p>
        </div>
    </div>
    ...
    <div style="background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 14px; padding: 18px; backdrop-filter: blur(10px);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.08);">
            <div>
                <span style="font-size: 17px; font-weight: 700; color: var(--text-primary);">铜冠铜箔</span>
                <span style="font-size: 12px; color: var(--text-muted); margin-left: 8px;">301217 · PCB铜箔+锂电铜箔</span>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 20px; font-weight: 700; color: #f87171;">132.09</div>
                <div style="font-size: 13px; color: #f87171; font-weight: 600;">-5.43%</div>
            </div>
        </div>
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 14px;">
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">成交额</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">49.93亿</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">换手率</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">4.32%</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">主力资金</div>
                <div style="font-size: 14px; font-weight: 700; color: #f87171;">-3.32亿</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">振幅</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">10.12%</div>
            </div>
        </div>
        <div style="line-height: 1.85; font-size: 13.5px; color: var(--text-secondary);">
            <p style="margin: 0 0 10px 0;"><strong style="color: #f87171;">📉 当日表现：午后大幅跳水，重挫逾5%</strong><br>
            铜冠铜箔今日开盘后冲高至146.15元（+4.6%），创下近期新高，但午后风云突变，跟随锂电+有色板块大幅跳水，最低探至132.01元，振幅高达10.12%，最终收于132.09元，跌幅5.43%。主力资金净流出3.32亿元，在电力设备板块资金流出榜上位居前列。今日走势呈现典型的"冲高回落+放量杀跌"形态，短期见顶信号明显。</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #fbbf24;">📊 技术面判断：破位下行，短期趋势走坏</strong><br>
            • <strong>均线系统</strong>：MA5(138.95)、MA10(149.79)、MA20(163.91)全部失守，短期均线空头排列发散，下跌趋势已确立<br>
            • <strong>支撑位</strong>：130元附近为心理关口+前期平台支撑，若跌破则看120元整数关口，再往下是100元中期支撑<br>
            • <strong>压力位</strong>：140-145元区域（MA5+今日开盘价）是短期强压力带，反弹到此位置承压概率大<br>
            • <strong>MACD</strong>：DIF 4.03，DEA 11.54，绿柱持续放大，空头动能正在增强<br>
            • <strong>RSI</strong>：22.14，已进入<strong style="color: #fbbf24;">严重超卖区域</strong>，短期或有技术性反弹需求，但反弹后可能继续探底<br>
            • <strong>量价关系</strong>：放量长阴+长上影线，是典型的顶部反转信号</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #60a5fa;">💰 资金面与基本面</strong><br>
            主力资金单日净流出3.32亿，机构抛售迹象明显。国轩高科上半年减持839.95万股也给市场带来了大股东减持的心理预期。但基本面上，公司Q1净利润同比增长2138.17%，业绩爆发式增长，PET铜箔和高频高速PCB铜箔两大业务均处于高景气周期。铜陵有色控股72.38%，国资背景提供安全垫。</p>
            
            <p style="margin: 0;"><strong style="color: #c084fc;">🎯 操作建议：反弹减仓为主，严控仓位</strong><br>
            • RSI超卖(22.14)意味着短期可能出现技术性反弹，但不宜期望过高<br>
            • 若反弹至<strong style="color: #4ade80;">140元以上</strong>，坚决减仓1/3，降低持仓风险<br>
            • 若跌破<strong style="color: #f87171;">128元</strong>，止损出局，下方空间可能打开至110-120元<br>
            • 中期等企稳信号：缩量至20亿以下+连续2日站稳MA10再考虑<br>
            • 仓位建议：减至1/4仓位，避免在下跌趋势中重仓博弈</p>
        </div>
    </div>
    ...
    <div style="background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 14px; padding: 18px; backdrop-filter: blur(10px);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.08);">
            <div>
                <span style="font-size: 17px; font-weight: 700; color: var(--text-primary);">雅克科技</span>
                <span style="font-size: 12px; color: var(--text-muted); margin-left: 8px;">002409 · 半导体材料平台龙头</span>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 20px; font-weight: 700; color: #f87171;">207.17</div>
                <div style="font-size: 13px; color: #f87171; font-weight: 600;">-0.88%</div>
            </div>
        </div>
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 14px;">
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">成交额</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">约100亿</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">最高/最低</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">229.00 / 207.00</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">振幅</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">10.5%</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">技术评级</div>
                <div style="font-size: 14px; font-weight: 700; color: #fbbf24;">观望(39分)</div>
            </div>
        </div>
        <div style="line-height: 1.85; font-size: 13.5px; color: var(--text-secondary);">
            <p style="margin: 0 0 10px 0;"><strong style="color: #fbbf24;">📈 当日表现：半导体暴跌中最抗跌的持仓</strong><br>
            雅克科技今日早盘冲高至229元（+9.6%），表现一度非常强势，但午后随着半导体板块集体跳水，股价快速回落，最低探至207元，最终收于207.17元，跌幅仅0.88%。在电子板块整体暴跌5.32%、存储芯片概念大幅回调的背景下，雅克科技仅微跌不足1%，表现<strong style="color: #4ade80;">显著抗跌</strong>，显示机构持仓稳定、抛压相对有限。</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #fbbf24;">📊 技术面判断：高位震荡，中长期趋势完好</strong><br>
            • <strong>均线系统</strong>：MA5(195.69)在上，MA10(205.85)今日被短暂跌破后收回，MA20(181.57)支撑强劲，中长期均线仍呈多头排列<br>
            • <strong>支撑位</strong>：<strong style="color: #4ade80;">200-205元</strong>（MA10区域）为第一支撑，强支撑在175元附近（前期平台+7月8日低点）<br>
            • <strong>压力位</strong>：230元（今日高点附近）为短期压力，246.44元（7月1日高点）为中期强压力<br>
            • <strong>MACD</strong>：DIF 20.96，DEA 22.11，绿柱放大，短期有调整需求，但零轴上方运行，中期趋势未坏<br>
            • <strong>RSI</strong>：62.97，处于正常区间，未进入超买也未超卖<br>
            • <strong>缺口支撑</strong>：下方存在多个向上跳空缺口（85.5元/116.9元/110元），中长期支撑层次丰富<br>
            • <strong>量价关系</strong>：高位放量长上影，短期有获利回吐压力，但未破关键支撑</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #60a5fa;">💰 资金面与基本面</strong><br>
            雅克科技是国内半导体材料平台型龙头，业务覆盖光刻胶（光刻胶单体+树脂）、电子特气、半导体前驱体三大高景气赛道，均处于国产替代加速期。存储芯片产业链景气上行+晶圆厂扩产+国产替代三重逻辑共振。今日在板块暴跌中仍能维持接近红盘，充分说明机构对其基本面的认可以及持仓稳定性。</p>
            
            <p style="margin: 0;"><strong style="color: #c084fc;">🎯 操作建议：核心底仓持有，回调加仓</strong><br>
            • 四只持仓中<strong style="color: #4ade80;">质地最优、抗跌性最强</strong>的标的，半导体材料平台龙头地位稳固<br>
            • 若回调至<strong style="color: #4ade80;">200元以下</strong>，可考虑加仓1/4，博弈半导体板块超跌反弹<br>
            • 若跌破<strong style="color: #f87171;">180元</strong>（MA20下方），止损减仓至1/2，防止中期趋势走坏<br>
            • 反弹至<strong style="color: #4ade80;">225元以上</strong>可减仓1/4做波段操作，降低持仓成本<br>
            • 中长期坚定看好，存储芯片产业链复苏+半导体材料国产替代双轮驱动</p>
        </div>
    </div>
    ...
    <div style="background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 14px; padding: 18px; backdrop-filter: blur(10px);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; padding-bottom: 12px; border-bottom: 1px solid rgba(255,255,255,0.08);">
            <div>
                <span style="font-size: 17px; font-weight: 700; color: var(--text-primary);">*ST建艺</span>
                <span style="font-size: 12px; color: #f87171; margin-left: 8px;">002789 · 高风险·建议清仓</span>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 20px; font-weight: 700; color: #f87171;">10.21</div>
                <div style="font-size: 13px; color: #f87171; font-weight: 600;">-1.64%</div>
            </div>
        </div>
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 14px;">
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">成交额</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">2164万</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">换手率</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">1.34%</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">主力资金</div>
                <div style="font-size: 14px; font-weight: 700; color: #f87171;">-213.5万</div>
            </div>
            <div style="background: rgba(255,255,255,0.04); border-radius: 8px; padding: 10px; text-align: center;">
                <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 3px;">总市值</div>
                <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">16.30亿</div>
            </div>
        </div>
        <div style="line-height: 1.85; font-size: 13.5px; color: var(--text-secondary);">
            <p style="margin: 0 0 10px 0;"><strong style="color: #f87171;">📉 当日表现：持续阴跌，弱势难改</strong><br>
            *ST建艺今日收跌1.64%报10.21元，成交额仅2164万元，换手率1.34%，继续沿下降通道下行。盘中最高10.50元，最低10.17元，波动不大但重心持续下移。主力资金净流出213.52万元，已连续3日被主力资金减仓。成交量持续低迷，缺乏资金关注。</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #fbbf24;">📊 技术面判断：典型空头排列</strong><br>
            • <strong>均线系统</strong>：MA5(10.53)、MA10(11.15)、MA20(12.24)全部失守，均线呈标准空头排列，下跌趋势明确<br>
            • <strong>支撑位</strong>：10元整数关口为短期心理支撑，跌破看9.7元（前期低点附近）<br>
            • <strong>压力位</strong>：10.5-11元（MA5+MA10区域）构成短期强压力<br>
            • <strong>MACD</strong>：DIF -0.75，DEA -0.52，绿柱虽略有缩小但仍在零轴下方，弱势格局未变<br>
            • <strong>RSI</strong>：17.97，<strong style="color: #f87171;">严重超卖</strong>，但ST股超卖状态可能持续很长时间，不能作为抄底依据<br>
            • <strong>筹码分布</strong>：平均成本12.43元，当前价位下方套牢盘沉重，反弹压力大</p>
            
            <p style="margin: 0 0 10px 0;"><strong style="color: #60a5fa;">💰 基本面与风险</strong><br>
            公司主营建筑装饰，受房地产行业下行冲击明显。2026年一季度营业收入同比减少35.21%，归母净利润亏损5311.52万元，亏损幅度扩大68.96%。公司被实施退市风险警示(*ST)，主业持续低迷，扭亏难度大。虽然有横琴新区、创投等概念标签，但概念炒作无法替代基本面的实质性改善。主板ST涨跌幅已扩至10%，波动风险进一步加大。</p>
            
            <p style="margin: 0;"><strong style="color: #c084fc;">🎯 操作建议：坚决清仓，不可加仓</strong><br>
            • <strong style="color: #f87171;">风险评级：极高</strong>，ST股在当前市场环境下风险收益比极差，建议无条件清仓<br>
            • 若反弹至<strong style="color: #4ade80;">10.5元以上</strong>，应果断清仓离场，不要抱有幻想<br>
            • 若跌破<strong style="color: #f87171;">10元整数关口</strong>，不计成本止损，下方空间可能很大<br>
            • 坚决不可抄底、不可加仓、不可补仓摊薄成本，ST股底部无法预测<br>
            • 腾挪出的资金建议转移到雅克科技等有基本面支撑的优质标的，或保留现金等待更好机会</p>
        </div>
    </div>
    
    <!-- 持仓总结 -->
    <div style="background: linear-gradient(135deg, rgba(251, 191, 36, 0.1), rgba(245, 158, 11, 0.05)); border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 12px; padding: 16px;">
        <div style="font-weight: 700; color: #fcd34d; margin-bottom: 10px; display: flex; align-items: center; gap: 8px;">
            <span>📋</span><span>持仓结构总评与下周操作总纲</span>
        </div>
        <div style="line-height: 1.8; font-size: 13px; color: var(--text-secondary);">
            <p style="margin: 0 0 8px 0;">当前四只持仓全部处于调整状态，但质地分化明显：<strong style="color: #4ade80;">雅克科技</strong>是质地最优的核心底仓，建议保留并逢低加仓；<strong style="color: #fbbf24;">英维克</strong>中期逻辑仍在但短期调整未结束，反弹减仓后保留底仓；<strong style="color: #f87171;">铜冠铜箔</strong>下跌趋势确立，建议大幅降低仓位；<strong style="color: #ef4444;">*ST建艺</strong>坚决清仓，避免退市风险。</p>
            <p style="margin: 0;">操作优先级：<strong>①清仓*ST建艺 → ②减仓铜冠铜箔 → ③减仓英维克 → ④加仓雅克科技 → ⑤新建仓紫光股份/金风科技</strong>。总仓位控制在40-50%，现金为王，等待科技板块企稳后再加仓。</p>
        </div>
    </div>
    
</div>
"""
gen._components.append(Section(title="💼 持仓股深度诊断", content=holdings_diagnosis_html, icon="briefcase"))
