...
gen.add_investment_opportunities([
    {
        "title": "🔥 优先级1：存储芯片链",
        "level": "S级",
        "rationale": "存储超级周期确认，2027年缺货最严峻，原厂长约锁至2028年，价格趋势明确向上。HBM供需极度紧张，DDR5/DDR4现货同步上涨。",
        "targets": [
    ...
    },
    {
        "title": "🚀 优先级2：AI算力基础设施",
        "level": "A级",
        "rationale": "黄仁勋销量翻倍指引击碎AI减速论，FY2028营收70%增长远超预期，AI资本开支确定性大幅提升。液冷、PCB、光模块等上游供应链直接受益。",
        "targets": [
    ...
    },
    {
        "title": "💎 优先级3：半导体设备材料",
        "level": "A级",
        "rationale": "全国先进制造业大会定调，自主可控政策加码+全球半导体景气上行双轮驱动。设备、零部件、材料国产替代加速。",
        "targets": [
