...
REPORT_TYPES = {
    ...
    "industry-chain": {"name": "产业链", "dir": "industry-chain", "list_file": "latest.html"},
    "weekly-review": {"name": "周复盘", "dir": "weekly-review", "list_file": "latest.html"},
    "weekly-outlook": {"name": "周三前瞻", "dir": "weekly-outlook", "list_file": "latest.html"},
    "weekend_express": {"name": "weekend-express", "dir": "weekend-express", "list_file": "latest.html"},
    "tomorrow_catalyst": {"name": "tomorrow-catalyst", "dir": "tomorrow-catalyst", "list_file": "latest.html"},
    "s_level_catalyst": {"name": "S级催化", "dir": "s-level-catalyst", "list_file": "latest.html"},
...
NAV_ITEMS = [
    ...
    {"key": "industry-chain", "label": "产业链", "icon": "🔗", "path": "/daily-news-insight/industry-chain/latest.html"},
    {"key": "weekly-review", "label": "周复盘", "icon": "📋", "path": "/daily-news-insight/weekly-review/latest.html"},
    {"key": "weekly-outlook", "label": "周三前瞻", "icon": "🔮", "path": "/daily-news-insight/weekly-outlook/latest.html"},
    {"key": "weekend_express", "label": "周末速递", "icon": "📦", "path": "/daily-news-insight/weekend-express/latest.html"},
    {"key": "tomorrow_catalyst", "label": "明日催化", "icon": "⏰", "path": "/daily-news-insight/tomorrow-catalyst/latest.html"},
    {"key": "s_level_catalyst", "label": "S级催化", "icon": "⭐", "path": "/daily-news-insight/s-level-catalyst/latest.html"},
