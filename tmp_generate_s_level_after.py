...
gen.add_industry_chain_analysis(
    upstream=[
        "AI芯片：英伟达（盘前+0.6%）、AMD、燧原科技（首日+179%）",
        "HBM/存储：SK海力士（盘前+1%）、美光（盘前+0.8%）、三星",
        "半导体设备：阿斯麦（盘前+1.5%）、台积电（8月营收+53.3%）",
    ],
    midstream=[
        "光模块/光通信：中际旭创（成交299.7亿居首）、新易盛、天孚通信",
        "PCB/高速铜连接：金安国纪（机构+13.79亿）、东山精密、沪电股份",
        "液冷散热：英维克、高澜股份（板块跟随调整）",
        "半导体材料：雅克科技（HBM前驱体）、华海诚科",
    ],
    downstream=[
        "AI云服务商：甲骨文（Q1云收入+121%）、AWS、Azure",
        "智算中心/数据中心运营商",
        "大模型/AI应用厂商",
    ]
)
...
gen.add_investment_opportunities([
    ...
    },
    {
        "title": "国产AI芯片",
        "level": "A级",
        "logic": "燧原科技上市首日+179%，国产AI芯片情绪高涨。美国出口管制背景下，国产替代加速推进。工信部印发《\"人工智能+软件\"专项行动实施方案》。",
        "targets": [
...
<b>【总体判断】</b>当前处于\"AI算力基本面超预期\"与\"宏观流动性收紧\"的博弈期。甲骨文财报验证了AI算力需求的真实性和持续性，FCC靴子落地解除了光通信最大政策风险，但CPI数据和美联储加息仍是短期压制因素。
<br><br>
<b>【仓位管理】</b>总仓位控制在60-70%，保留30%+现金应对周末不确定性。左侧抄底不超过30%，等待CPI数据和下周一趋势确认后再加仓。
<br><br>
<b>【持仓操作】</b><br>
