        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-white font-bold text-xl">题材深度分析</h1>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    <span class="px-4 py-2 bg-white/20 text-white rounded-full text-sm font-semibold">{level}级题材</span>
                </div>
            </div>
        </div>
    </nav>
    ...
    <nav class="glass-nav fixed top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <span class="px-4 py-2 bg-white/20 text-white rounded-full text-sm font-semibold">
                    共 {len(s_topics) + len(a_topics) + len(b_topics)} 个题材
                </span>
            </div>
        </div>
    </nav>
